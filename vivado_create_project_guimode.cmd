...
@set VIVADO_XSETTINGS=D:\Xilinx\Vivado\%VIVADO_VERSION%\settings64.bat
@set SDK_XSETTINGS=D:\Xilinx\SDK\%VIVADO_VERSION%\settings64.bat
@set LABTOOL_XSETTINGS=D:\Xilinx\Vivado_Lab\%VIVADO_VERSION%\settings64.bat
@if not defined ENABLE_SDSOC (
  @set ENABLE_SDSOC=0
)
@if %ENABLE_SDSOC%==1 (
  @echo --Info: SDSOC use Vivado and SDK from SDx installation --
  @set SDSOC_XSETTINGS=D:\Xilinx\SDx\%VIVADO_VERSION%\settings64.bat
  @set VIVADO_XSETTINGS=D:\Xilinx\SDx\%VIVADO_VERSION%\Vivado\.settings64-Vivado.bat
)
@REM # --------------------
