...
@echo -- (7)  labtools_open_project_guimode.cmd
@echo -- (8)  program_flash_binfile.cmd
@echo -- (9)  program_flash_mcsfile.cmd
@echo -- (10) program_fpga_bitfile.cmd
@echo -- (11) sdk_create_prebuilt_project_guimode.cmd
@echo -- (12) vivado_create_project_batchmode.cmd
