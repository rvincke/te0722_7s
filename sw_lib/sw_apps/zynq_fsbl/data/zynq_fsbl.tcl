...
proc swapp_get_description {} {
	...
	\
  TE-Modification: Modified FSBL to run on DDR Less Zynq PS. See main.c and: https://wiki.trenz-electronic.de/display/PD/DDR+less+ZYNQ+Design \
  Insert Hello TE0722, see fsbl_hooks.c \
  FSBL Template: 2017.1\
  ";
}
